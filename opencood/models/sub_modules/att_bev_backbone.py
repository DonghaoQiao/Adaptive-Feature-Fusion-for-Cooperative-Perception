...
class AttBEVBackbone(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        for i in range(len(self.blocks)):
            ...
            # x_fuse: torch.Size([1, 64, 100, 352])
            # x_fuse: torch.Size([1, 128, 50, 176])
            # x_fuse: torch.Size([1, 256, 25, 88])
        ...
        if len(self.deblocks) > len(self.blocks):
            x = self.deblocks[-1](x)
        # print('final x:', x.shape) # [1, 384, 100, 352]
